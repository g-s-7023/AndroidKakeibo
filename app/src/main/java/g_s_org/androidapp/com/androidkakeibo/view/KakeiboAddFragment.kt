...
import g_s_org.androidapp.com.androidkakeibo.model.DBAccessHelper
import g_s_org.androidapp.com.androidkakeibo.dbaccess.DetailHistoryAccess
import g_s_org.androidapp.com.androidkakeibo.model.FragmentToActivityInterection
import g_s_org.androidapp.com.androidkakeibo.model.KakeiboDBAccess
...
class KakeiboAddFragment : KakeiboInputFragment() {
    ...
    override fun onLeftButtonClicked() {
        ...
        (mCaller.getSystemService(Context.INPUT_METHOD_SERVICE) as InputMethodManager)
                .hideSoftInputFromWindow((mCaller.findViewById(R.id.et_category) as EditText).windowToken, InputMethodManager.RESULT_UNCHANGED_SHOWN)
    }
