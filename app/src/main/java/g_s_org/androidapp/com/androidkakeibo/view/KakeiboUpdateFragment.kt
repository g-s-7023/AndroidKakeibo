...
import g_s_org.androidapp.com.androidkakeibo.model.getPrice
import g_s_org.androidapp.com.androidkakeibo.model.setPrice
...
class KakeiboUpdateFragment : KakeiboInputFragment() {
    ...
    override fun onCenterButtonClicked() {
        ...
        // if category is empty, no data is updated
